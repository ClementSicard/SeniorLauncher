...
class ContactModel extends ChangeNotifier {
  ...
  void sendSMSPhoneNumber(String number) async {
    NativeMethods().sendSMStoANumber(number);
  }

  void goToWhatsAppConv(String number) async {
    NativeMethods().launchWhatsAppConv(number);
  }
